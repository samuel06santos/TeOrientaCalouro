...
export const contatos: Contato[] = [
  { setor: 'Coordenação do curso', assunto: 'Matrícula, turmas, aproveitamento e rotina do curso', descricao: 'É o primeiro contato para questões específicas da sua graduação. Encontre sua unidade no diretório institucional.', url: 'https://www.ufpa.br/index.php/unidades' },
